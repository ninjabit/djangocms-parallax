...
from djangocms_parallax.models import Parallax, ParallaxContent, ParallaxImage
...
class ParallaxPlugin(CMSPluginBase):
    ...
    render_template = 'cms/plugins/parallax.html'
...
class ParallaxContentPlugin(CMSPluginBase):
    ...
    render_template = 'cms/plugins/parallax_content.html'
...
class ParallaxImagePlugin(CMSPluginBase):
    ...
    render_template = 'cms/plugins/parallax_image.html'
